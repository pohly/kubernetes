...
func AddKubeletConfigFlags(mainfs *pflag.FlagSet, c *kubeletconfig.KubeletConfiguration) {
	...
	fs.DurationVar(&c.DRAManagerReconcilePeriod.Duration, "dra-manager-reconcile-period", c.DRAManagerReconcilePeriod.Duration, "<Warning: Alpha feature> DRA Manager reconciliation period. Examples: '10s', or '1m'. If not supplied, defaults to 'NodeStatusUpdateFrequency'")
}
