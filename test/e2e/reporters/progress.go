...
// SuiteWillBegin is invoked by ginkgo when the suite is about to start and is the first point in which we can
...
// SuiteDidEnd is the last method invoked by Ginkgo after all the specs are run.
