...
var _ = ginkgo.Describe("[sig-node] DRA [Feature:DynamicResourceAllocation]", func() {
	...
	ginkgo.Context("kubelet", func() {
		...
		ginkgo.It("must unprepare resources for force-deleted pod", func() {
			...
			pod.ObjectMeta.DeletionGracePeriodSeconds = &zero
...
func (b *builder) class() *v1.ResourceClass {
	...
	if b.classParametersName != "" {
		class.ParametersRef = &v1.ResourceClassParametersReference{
			Kind:      "ConfigMap",
...
func (b *builder) externalClaim(allocationMode v1.AllocationMode) *v1.ResourceClaim {
	...
	return &v1.ResourceClaim{
		...
		Spec: v1.ResourceClaimSpec{
			...
			ParametersRef: &v1.ResourceClaimParametersReference{
				Kind: "ConfigMap",
