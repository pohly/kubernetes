...
type EphemeralTest struct {
	...
	GetVolumeAttributes func(volumeNumber int) (attributes map[string]string, shared bool, readWrite bool)
...
func StartInPodWithInlineVolume(c clientset.Interface, ns, podName, command string, csiVolumes []v1.CSIVolumeSource, node framework.NodeSelection) *v1.Pod {
	pod := &v1.Pod{
