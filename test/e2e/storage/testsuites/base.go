...
func SetupTestSuite(f *framework.Framework, driver TestDriver, config *TestConfig, tsInits []func() TestSuite, tunePatternFunc func([]testpatterns.TestPattern) []testpatterns.TestPattern) {
