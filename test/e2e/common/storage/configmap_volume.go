...
var _ = SIGDescribe("ConfigMap", func() {
	...
	*/
	framework.ConformanceIt("should be consumable from pods in volume", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should be consumable from pods in volume with defaultMode set [LinuxOnly]", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should be consumable from pods in volume as non-root", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should be consumable from pods in volume with mappings", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	/*
		...
		This test is marked LinuxOnly since Windows does not support setting specific file permissions.
	*/
	framework.ConformanceIt("should be consumable from pods in volume with mappings and Item mode set [LinuxOnly]", framework.WithNodeConformance(), func(ctx context.Context) {
		mode := int32(0400)
	...
	*/
	framework.ConformanceIt("should be consumable from pods in volume with mappings as non-root", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("updates should be reflected in volume", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("binary data should be reflected in volume", framework.WithNodeConformance(), func(ctx context.Context) {
		podLogTimeout := e2epod.GetPodSecretUpdateTimeout(ctx, f.ClientSet)
		containerTimeoutArg := fmt.Sprintf("--retry_time=%v", int(podLogTimeout.Seconds()))
	...
	*/
	framework.ConformanceIt("optional updates should be reflected in volume", framework.WithNodeConformance(), func(ctx context.Context) {
		podLogTimeout := e2epod.GetPodSecretUpdateTimeout(ctx, f.ClientSet)
		containerTimeoutArg := fmt.Sprintf("--retry_time=%v", int(podLogTimeout.Seconds()))
		trueVal := true
	...
	*/
	framework.ConformanceIt("should be consumable in multiple volumes in the same pod", framework.WithNodeConformance(), func(ctx context.Context) {
		var (
