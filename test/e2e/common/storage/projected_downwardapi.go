...
var _ = SIGDescribe("Projected downwardAPI", func() {
	...
	*/
	framework.ConformanceIt("should provide podname only", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should set DefaultMode on files [LinuxOnly]", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downwardapi-volume-" + string(uuid.NewUUID())
	...
	/*
	   ...
	   This test is marked LinuxOnly since Windows does not support setting specific file permissions.
	*/
	framework.ConformanceIt("should set mode on item file [LinuxOnly]", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downwardapi-volume-" + string(uuid.NewUUID())
		mode := int32(0400)
	...
	*/
	framework.ConformanceIt("should update labels on modification", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should update annotations on modification", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should provide container's cpu limit", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downwardapi-volume-" + string(uuid.NewUUID())
	...
	*/
	framework.ConformanceIt("should provide container's memory limit", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downwardapi-volume-" + string(uuid.NewUUID())
	...
	*/
	framework.ConformanceIt("should provide container's cpu request", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downwardapi-volume-" + string(uuid.NewUUID())
	...
	*/
	framework.ConformanceIt("should provide container's memory request", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downwardapi-volume-" + string(uuid.NewUUID())
	...
	*/
	framework.ConformanceIt("should provide node allocatable (cpu) as default cpu limit if the limit is not set", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downwardapi-volume-" + string(uuid.NewUUID())
	...
	*/
	framework.ConformanceIt("should provide node allocatable (memory) as default memory limit if the limit is not set", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downwardapi-volume-" + string(uuid.NewUUID())
