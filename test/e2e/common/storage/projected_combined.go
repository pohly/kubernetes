...
var _ = SIGDescribe("Projected combined", func() {
	...
	*/
	framework.ConformanceIt("should project all components that make up the projection API [Projection]", framework.WithNodeConformance(), func(ctx context.Context) {
		var err error
