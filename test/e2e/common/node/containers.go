...
var _ = SIGDescribe("Containers", func() {
	...
	*/
	framework.ConformanceIt("should use the image defaults if command and args are blank", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should be able to override the image's default arguments (container cmd)", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should be able to override the image's default command (container entrypoint)", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should be able to override the image's default command and arguments", framework.WithNodeConformance(), func(ctx context.Context) {
		pod := entrypointTestPod(f.Namespace.Name, "entrypoint-tester", "override", "arguments")
		pod.Spec.Containers[0].Command = []string{"/agnhost-2"}
