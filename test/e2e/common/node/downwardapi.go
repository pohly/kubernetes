...
var _ = SIGDescribe("Downward API", func() {
	...
	*/
	framework.ConformanceIt("should provide pod name, namespace and IP address as env vars", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should provide host IP as an env var", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downward-api-" + string(uuid.NewUUID())
		env := []v1.EnvVar{
			{
				Name: "HOST_IP",
	...
	*/
	framework.ConformanceIt("should provide container's limits.cpu/memory and requests.cpu/memory as env vars", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downward-api-" + string(uuid.NewUUID())
		env := []v1.EnvVar{
			{
				Name: "CPU_LIMIT",
	...
	*/
	framework.ConformanceIt("should provide default limits.cpu/memory from node allocatable", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downward-api-" + string(uuid.NewUUID())
		env := []v1.EnvVar{
			{
				Name: "CPU_LIMIT",
	...
	*/
	framework.ConformanceIt("should provide pod UID as env vars", framework.WithNodeConformance(), func(ctx context.Context) {
		podName := "downward-api-" + string(uuid.NewUUID())
		env := []v1.EnvVar{
			{
				Name: "POD_UID",
