...
var _ = SIGDescribe("Pods", func() {
	...
	*/
	framework.ConformanceIt("should get a host IP", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should be submitted and removed", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should be updated", framework.WithNodeConformance(), func(ctx context.Context) {
		ginkgo.By("creating the pod")
	...
	*/
	framework.ConformanceIt("should allow activeDeadlineSeconds to be updated", framework.WithNodeConformance(), func(ctx context.Context) {
		ginkgo.By("creating the pod")
	...
	*/
	framework.ConformanceIt("should contain environment variables for services", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should support remote command execution over websockets", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should support retrieving logs from the container over websockets", framework.WithNodeConformance(), func(ctx context.Context) {
		config, err := framework.LoadConfig()
		framework.ExpectNoError(err, "unable to get base config")
