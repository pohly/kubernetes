...
var _ = SIGDescribe("Security Context", func() {
	...
	ginkgo.Context("When creating a container with runAsUser", func() {
		...
		*/
		framework.ConformanceIt("should run the container with uid 65534 [LinuxOnly]", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	ginkgo.Context("When creating a pod with readOnlyRootFilesystem", func() {
		...
		*/
		framework.ConformanceIt("should run the container with writable rootfs when readOnlyRootFilesystem=false", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	ginkgo.Context("When creating a pod with privileged", func() {
		...
		*/
		framework.ConformanceIt("should run the container as unprivileged when false [LinuxOnly]", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	ginkgo.Context("when creating containers with AllowPrivilegeEscalation", func() {
		...
		*/
		...
		/*
			...
			[LinuxOnly]: This test is marked LinuxOnly since Windows does not support running as UID / GID, or privilege escalation.
		*/
		framework.ConformanceIt("should not allow privilege escalation when false [LinuxOnly]", framework.WithNodeConformance(), func(ctx context.Context) {
