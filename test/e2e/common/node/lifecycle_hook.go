...
var _ = SIGDescribe("Container Lifecycle Hook", func() {
	...
	ginkgo.Context("when create a pod with lifecycle hook", func() {
		...
		*/
		framework.ConformanceIt("should execute poststart exec hook properly", framework.WithNodeConformance(), func(ctx context.Context) {
		...
		*/
		framework.ConformanceIt("should execute prestop exec hook properly", framework.WithNodeConformance(), func(ctx context.Context) {
			lifecycle := &v1.Lifecycle{
		...
		*/
		framework.ConformanceIt("should execute poststart http hook properly", framework.WithNodeConformance(), func(ctx context.Context) {
			lifecycle := &v1.Lifecycle{
				PostStart: &v1.LifecycleHandler{
		...
		*/
		framework.ConformanceIt("should execute prestop http hook properly", framework.WithNodeConformance(), func(ctx context.Context) {
			lifecycle := &v1.Lifecycle{
				PreStop: &v1.LifecycleHandler{
					HTTPGet: &v1.HTTPGetAction{
