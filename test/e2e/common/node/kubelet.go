...
var _ = SIGDescribe("Kubelet", func() {
	...
	ginkgo.Context("when scheduling a busybox command in a pod", func() {
		...
		*/
		framework.ConformanceIt("should print the output to logs", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	ginkgo.Context("when scheduling a busybox command that always fails in a pod", func() {
		...
		*/
		framework.ConformanceIt("should have an terminated reason", framework.WithNodeConformance(), func(ctx context.Context) {
		...
		*/
		framework.ConformanceIt("should be possible to delete", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	ginkgo.Context("when scheduling an agnhost Pod with hostAliases", func() {
		...
		*/
		framework.ConformanceIt("should write entries to /etc/hosts", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	ginkgo.Context("when scheduling a read only busybox container", func() {
		...
		*/
		framework.ConformanceIt("should not write to root filesystem [LinuxOnly]", framework.WithNodeConformance(), func(ctx context.Context) {
			isReadOnly := true
			podClient.CreateSync(ctx, &v1.Pod{
				ObjectMeta: metav1.ObjectMeta{
					Name: podName,
