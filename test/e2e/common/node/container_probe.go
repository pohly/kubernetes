...
var _ = SIGDescribe("Probing container", func() {
	...
	*/
	framework.ConformanceIt("with readiness probe should not be ready before initial delay and never restart", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("with readiness probe that fails should never be ready and never restart", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should be restarted with a exec \"cat /tmp/health\" liveness probe", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should *not* be restarted with a exec \"cat /tmp/health\" liveness probe", framework.WithNodeConformance(), func(ctx context.Context) {
	...
	*/
	framework.ConformanceIt("should be restarted with a /healthz http liveness probe", framework.WithNodeConformance(), func(ctx context.Context) {
		livenessProbe := &v1.Probe{
	...
	*/
	framework.ConformanceIt("should *not* be restarted with a tcp:8080 liveness probe", framework.WithNodeConformance(), func(ctx context.Context) {
		livenessProbe := &v1.Probe{
	...
	*/
	framework.ConformanceIt("should have monotonically increasing restart count", framework.WithNodeConformance(), func(ctx context.Context) {
		livenessProbe := &v1.Probe{
			ProbeHandler:        httpGetHandler("/healthz", 8080),
	...
	*/
	framework.ConformanceIt("should *not* be restarted with a /healthz http liveness probe", framework.WithNodeConformance(), func(ctx context.Context) {
		livenessProbe := &v1.Probe{
