...
var _ = SIGDescribe("ControllerRevision [Serial]", func() {
	...
	*/
	framework.ConformanceIt("should manage the lifecycle of a ControllerRevision", func(ctx context.Context) {
		...
		gomega.Expect(patchedControllerRevision.Labels[initialRevision.Name]).To(gomega.Equal("patched"), "Did not find 'patched' label for this ControllerRevision. Current labels: %v", patchedControllerRevision.Labels)
		...
		gomega.Expect(updatedControllerRevision.Labels[currentControllerRevision.Name]).To(gomega.Equal("updated"), "Did not find 'updated' label for this ControllerRevision. Current labels: %v", currentControllerRevision.Labels)
