...
var _ = sigDescribe("Kubelet-Stats", feature.Windows, framework.WithSerial(), skipUnlessWindows(func() {
...
var _ = sigDescribe("Kubelet-Stats", feature.Windows, skipUnlessWindows(func() {
