...
var _ = sigDescribe("RebootHost containers", feature.Windows, "[Excluded:WindowsDocker] [MinimumKubeletVersion:1.22]", framework.WithSerial(), framework.WithDisruptive(), framework.WithSlow(), skipUnlessWindows(func() {
