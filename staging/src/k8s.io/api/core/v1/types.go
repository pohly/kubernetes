...
type ClaimSource struct {
	...
	// will also be deleted. The ResourceClaim will have a name that is
	// generated with <pod name>-<resource name> as base and the Pod as
	// owner. The generated name gets recorded in
