...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodResourceClaimReference) DeepCopyInto(out *PodResourceClaimReference) {
	*out = *in
	if in.Name != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodResourceClaimReference.
func (in *PodResourceClaimReference) DeepCopy() *PodResourceClaimReference {
	if in == nil {
		return nil
	}
	out := new(PodResourceClaimReference)
	in.DeepCopyInto(out)
	return out
}
