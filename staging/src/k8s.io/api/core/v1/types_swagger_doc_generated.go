...
var map_CSIVolumeSource = map[string]string{
	...
	"fsSize":               "Desired size of the volume, specified as a quantity string (ex. \"1Gi\"). Introduced as alpha field in Kubernetes 1.18. Prior to that, CSI drivers had to rely on a custom parameter in VolumeAttributes. Whether they continue to do that or use this field depends on the driver.",
