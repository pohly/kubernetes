...
import (
	...
	namedresourcesv1alpha1 "k8s.io/api/resource/structured/namedresources/v1alpha1"
...
type AllocationResultModel struct {
	// +optional
	NamedResources *namedresourcesv1alpha1.AllocationResult `json:"namedResources,omitempty" protobuf:"bytes,1,opt,name=namedResources"`
}
...
type NodeResourceModel struct {
	// +optional
	NamedResources *namedresourcesv1alpha1.Resources `json:"namedResources,omitempty" protobuf:"bytes,1,opt,name=namedResources"`
}
...
type ResourceRequestModel struct {
	// +optional
	NamedResources *namedresourcesv1alpha1.Request `json:"namedResources,omitempty" protobuf:"bytes,1,opt,name=namedResources"`
}
...
type ResourceFilterModel struct {
	// +optional
	NamedResources *namedresourcesv1alpha1.Filter `json:"namedResources,omitempty" protobuf:"bytes,1,opt,name=namedResources"`
}
