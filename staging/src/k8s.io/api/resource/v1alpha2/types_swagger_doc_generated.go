...
var map_StructuredResourceHandle = map[string]string{
	...
	"nodeName":              "NodeName is the name of the node providing the necessary resources. This mirrors the AllocationResult.AvailableOnNodes with a simpler type.\n\nThe driver name is the one stored in ResourceHandle.",
	"results":               "Results has one entry for each request for the driver in the claim parameters.",
}
