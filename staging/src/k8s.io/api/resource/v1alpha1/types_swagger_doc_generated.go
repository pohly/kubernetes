...
var map_PodScheduling = map[string]string{
	...
	"metadata": "The name must be the same as the corresponding Pod. That Pod must be listed as owner in OwnerReferences to ensure that the PodScheduling object gets deleted when no longer needed.\n\nPodScheduling objects where the owning Pod already got deleted no longer need to be updated because they will be removed soon.",
...
var map_ResourceClaimSchedulingStatus = map[string]string{
	...
	"podClaimName":    "PodClaimName matches the pod.spec.resourceClaims[*].Name field.",
...
var map_ResourceClaimTemplate = map[string]string{
	...
	"metadata": "Standard object metadata of the claim template object. The metadata of the claim that gets generated from this template is defined in the spec.",
