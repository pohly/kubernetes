...
var map_BasicDevice = map[string]string{
	"":           "BasicDevice defines one device instance using fields that are supported by all clients which support DRA.",
...
var map_Device = map[string]string{
	...
	"basic": "Basic defines one device instance using fields that are supported by all clients which support DRA.",
}
...
var map_ResourceSliceSpec = map[string]string{
	...
	"pool":         "Pool describes the pool that this ResourceSlice belongs to. This field is immutable.",
