...
type Device struct {
	...
	// Basic defines one device instance using fields that are supported
	// by all clients which support DRA.
	//
	// +optional
	// +oneOf=deviceType
...
// BasicDevice defines one device instance using fields that are supported
// by all clients which support DRA.
...
type DeviceRequest struct {
	...
	//
	// +optional
	CountMode DeviceCountMode `json:"countMode,omitempty" protobuf:"bytes,4,opt,name=countMode"`
