...
func (in *AllocatedInstance) DeepCopyInto(out *AllocatedInstance) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AllocatedInstance.
func (in *AllocatedInstance) DeepCopy() *AllocatedInstance {
	if in == nil {
		return nil
	}
	out := new(AllocatedInstance)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AllocationResult) DeepCopyInto(out *AllocationResult) {
	*out = *in
	if in.Instances != nil {
		...
		*out = make([]AllocatedInstance, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Int64Slice) DeepCopyInto(out *Int64Slice) {
	*out = *in
	if in.Ints != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Int64Slice.
func (in *Int64Slice) DeepCopy() *Int64Slice {
	if in == nil {
		return nil
	}
	out := new(Int64Slice)
