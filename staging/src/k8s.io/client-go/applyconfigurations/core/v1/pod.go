...
type PodApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty" protobuf:"bytes,2,opt,name=metadata"`
	Spec                             *PodSpecApplyConfiguration   `json:"spec,omitempty" protobuf:"bytes,3,opt,name=spec"`
	Status                           *PodStatusApplyConfiguration `json:"status,omitempty" protobuf:"bytes,4,opt,name=status"`
}
