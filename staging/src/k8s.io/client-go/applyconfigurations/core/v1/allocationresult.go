...
type AllocationResultApplyConfiguration struct {
	...
	ShareableResource *bool                           `json:"shareableResource,omitempty"`
}
...
// WithShareableResource sets the ShareableResource field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ShareableResource field is set to the value of the last call.
func (b *AllocationResultApplyConfiguration) WithShareableResource(value bool) *AllocationResultApplyConfiguration {
	b.ShareableResource = &value
	return b
}
