...
type ResourceRequestModelApplyConfiguration struct {
	NamedResources *v1alpha1.RequestApplyConfiguration `json:"namedResources,omitempty"`
}
...
func (b *ResourceRequestModelApplyConfiguration) WithNamedResources(value *v1alpha1.RequestApplyConfiguration) *ResourceRequestModelApplyConfiguration {
