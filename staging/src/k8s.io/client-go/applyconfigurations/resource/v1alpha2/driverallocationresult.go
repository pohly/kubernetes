...
func (b *DriverAllocationResultApplyConfiguration) WithNamedResources(value *v1alpha1.AllocationResultApplyConfiguration) *DriverAllocationResultApplyConfiguration {
