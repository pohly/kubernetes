...
import (
	v1alpha1 "k8s.io/client-go/applyconfigurations/namedresources/v1alpha1"
)
...
type AllocationResultModelApplyConfiguration struct {
	NamedResources *v1alpha1.AllocationResultApplyConfiguration `json:"namedResources,omitempty"`
}
...
func (b *AllocationResultModelApplyConfiguration) WithNamedResources(value *v1alpha1.AllocationResultApplyConfiguration) *AllocationResultModelApplyConfiguration {
