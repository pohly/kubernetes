...
type NodeResourceModelApplyConfiguration struct {
	NamedResources *v1alpha1.ResourcesApplyConfiguration `json:"namedResources,omitempty"`
}
...
func (b *NodeResourceModelApplyConfiguration) WithNamedResources(value *v1alpha1.ResourcesApplyConfiguration) *NodeResourceModelApplyConfiguration {
