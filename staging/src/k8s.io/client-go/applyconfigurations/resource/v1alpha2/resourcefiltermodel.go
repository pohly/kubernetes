...
type ResourceFilterModelApplyConfiguration struct {
	NamedResources *v1alpha1.FilterApplyConfiguration `json:"namedResources,omitempty"`
}
...
func (b *ResourceFilterModelApplyConfiguration) WithNamedResources(value *v1alpha1.FilterApplyConfiguration) *ResourceFilterModelApplyConfiguration {
