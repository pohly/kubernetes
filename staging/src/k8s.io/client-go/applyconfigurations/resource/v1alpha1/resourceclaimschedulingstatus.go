...
// WithPodClaimName sets the PodClaimName field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the PodClaimName field is set to the value of the last call.
func (b *ResourceClaimSchedulingStatusApplyConfiguration) WithPodClaimName(value string) *ResourceClaimSchedulingStatusApplyConfiguration {
	b.PodClaimName = &value
	return b
}
