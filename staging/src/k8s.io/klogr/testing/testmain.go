...
// NewTestContext returns a logger and context for use in a unit test case with
// the default logging configuration. TestMainWithLogging can be used to enable
// command line flags that modify those defaults.
func NewTestContext(t *testing.T) (logr.Logger, context.Context) {
	logger := NewLogger(t, DefaultOptions)
