...
func TestKvListFormat(t *testing.T) {
	var testKVList = []struct {
		...
		{
			keysValues: []interface{}{"pod", klogr.KRef("kube-system", "kubedns"), "status", "ready"},
			want:       ` pod="kube-system/kubedns" status="ready"`,
		},
		{
			keysValues: []interface{}{"pod", klogr.KRef("", "kubedns"), "status", "ready"},
			want:       ` pod="kubedns" status="ready"`,
		},
		{
			keysValues: []interface{}{"pod", klogr.KObj(test.KMetadataMock{Name: "test-name", NS: "test-ns"}), "status", "ready"},
			want:       ` pod="test-ns/test-name" status="ready"`,
		},
		{
			keysValues: []interface{}{"pod", klogr.KObj(test.KMetadataMock{Name: "test-name", NS: ""}), "status", "ready"},
			want:       ` pod="test-name" status="ready"`,
		},
		{
			keysValues: []interface{}{"pod", klogr.KObj(nil), "status", "ready"},
			want:       ` pod="" status="ready"`,
		},
		{
			keysValues: []interface{}{"pod", klogr.KObj((*test.PtrKMetadataMock)(nil)), "status", "ready"},
			want:       ` pod="" status="ready"`,
		},
		{
			keysValues: []interface{}{"pod", klogr.KObj((*test.KMetadataMock)(nil)), "status", "ready"},
			want:       ` pod="" status="ready"`,
		},
	}
