...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ResourceSliceList)(nil), (*v1alpha3.ResourceSliceList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_ResourceSliceList_To_v1alpha3_ResourceSliceList(a.(*ResourceSliceList), b.(*v1alpha3.ResourceSliceList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha3.ResourceSliceList)(nil), (*ResourceSliceList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_ResourceSliceList_To_api_ResourceSliceList(a.(*v1alpha3.ResourceSliceList), b.(*ResourceSliceList), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*BasicDevice)(nil), (*v1alpha3.BasicDevice)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*v1alpha3.BasicDevice)(nil), (*BasicDevice)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_BasicDevice_To_api_BasicDevice(a.(*v1alpha3.BasicDevice), b.(*BasicDevice), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*v1alpha3.ResourceSliceSpec)(nil), (*ResourceSliceSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_api_Device_To_v1alpha3_Device(in *Device, out *v1alpha3.Device, s conversion.Scope) error {
	...
	if in.Basic != nil {
		...
		*out = new(v1alpha3.BasicDevice)
		if err := Convert_api_BasicDevice_To_v1alpha3_BasicDevice(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Basic = nil
...
func autoConvert_v1alpha3_Device_To_api_Device(in *v1alpha3.Device, out *Device, s conversion.Scope) error {
	...
	if in.Basic != nil {
		in, out := &in.Basic, &out.Basic
		*out = new(BasicDevice)
		if err := Convert_v1alpha3_BasicDevice_To_api_BasicDevice(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Basic = nil
...
func autoConvert_api_ResourceSliceList_To_v1alpha3_ResourceSliceList(in *ResourceSliceList, out *v1alpha3.ResourceSliceList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]v1alpha3.ResourceSlice, len(*in))
		for i := range *in {
			if err := Convert_api_ResourceSlice_To_v1alpha3_ResourceSlice(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_api_ResourceSliceList_To_v1alpha3_ResourceSliceList is an autogenerated conversion function.
func Convert_api_ResourceSliceList_To_v1alpha3_ResourceSliceList(in *ResourceSliceList, out *v1alpha3.ResourceSliceList, s conversion.Scope) error {
	return autoConvert_api_ResourceSliceList_To_v1alpha3_ResourceSliceList(in, out, s)
}

func autoConvert_v1alpha3_ResourceSliceList_To_api_ResourceSliceList(in *v1alpha3.ResourceSliceList, out *ResourceSliceList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ResourceSlice, len(*in))
		for i := range *in {
			if err := Convert_v1alpha3_ResourceSlice_To_api_ResourceSlice(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_v1alpha3_ResourceSliceList_To_api_ResourceSliceList is an autogenerated conversion function.
func Convert_v1alpha3_ResourceSliceList_To_api_ResourceSliceList(in *v1alpha3.ResourceSliceList, out *ResourceSliceList, s conversion.Scope) error {
	return autoConvert_v1alpha3_ResourceSliceList_To_api_ResourceSliceList(in, out, s)
}
