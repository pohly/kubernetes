...
func autoConvert_api_Device_To_v1beta1_Device(in *Device, out *v1beta1.Device, s conversion.Scope) error {
	...
	// WARNING: in.Composite requires manual conversion: inconvertible types (k8s.io/dynamic-resource-allocation/api.CompositeDevice vs *k8s.io/api/resource/v1beta1.CompositeDevice)
	return nil
}
...
func autoConvert_v1beta1_Device_To_api_Device(in *v1beta1.Device, out *Device, s conversion.Scope) error {
	...
	// WARNING: in.Composite requires manual conversion: inconvertible types (*k8s.io/api/resource/v1beta1.CompositeDevice vs k8s.io/dynamic-resource-allocation/api.CompositeDevice)
	return nil
}
