...
// FeatureGates consists of logging feature gates. They must be added to a
// MutableFeatureGate by the user of the package because this package itself
// should not and cannot (import cycle) depend on the normal
