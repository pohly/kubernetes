...
func startRegistrar(logger klog.Logger, grpcVerbosity int, driverName string, endpoint string, pluginRegistrationEndpoint endpoint) (*nodeRegistrar, error) {
	n := &nodeRegistrar{
		logger: logger,
	...
	s, err := startGRPCServer(logger, grpcVerbosity, pluginRegistrationEndpoint, func(grpcServer *grpc.Server) {
