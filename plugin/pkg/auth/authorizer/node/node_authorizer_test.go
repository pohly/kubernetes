...
func TestAuthorizer(t *testing.T) {
	...
	nodes, pods, pvs, attachments, capacities := generate(opts)
	populate(g, nodes, pods, pvs, attachments, capacities)
	...
	tests := []struct {
		...
		{
			name:   "disallowed NodeResourceCapacity with subresource",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "get", Resource: "noderesourcecapacities", Subresource: "status", APIGroup: "resource.k8s.io", Name: "capacity0-node0"},
			expect: authorizer.DecisionNoOpinion,
		},
		{
			name:   "disallowed get another node's NodeResourceCapacity",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "get", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io", Name: "capacity0-node1"},
			expect: authorizer.DecisionNoOpinion,
		},
		{
			name:   "disallowed update another node's NodeResourceCapacity",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "update", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io", Name: "capacity0-node1"},
			expect: authorizer.DecisionNoOpinion,
		},
		{
			name:   "disallowed patch another node's NodeResourceCapacity",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "patch", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io", Name: "capacity0-node1"},
			expect: authorizer.DecisionNoOpinion,
		},
		{
			name:   "disallowed delete another node's NodeResourceCapacity",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "delete", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io", Name: "capacity0-node1"},
			expect: authorizer.DecisionNoOpinion,
		},
		{
			name:   "allowed list NodeResourceCapacities",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "list", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io"},
			expect: authorizer.DecisionAllow,
		},
		{
			name:   "allowed watch NodeResourceCapacities",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "watch", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io"},
			expect: authorizer.DecisionAllow,
		},
		{
			name:   "allowed get NodeResourceCapacity",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "get", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io", Name: "capacity0-node0"},
			expect: authorizer.DecisionAllow,
		},
		{
			name:   "allowed create NodeResourceCapacity",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "create", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io", Name: "capacity0-node0"},
			expect: authorizer.DecisionAllow,
		},
		{
			name:   "allowed update NodeResourceCapacity",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "update", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io", Name: "capacity0-node0"},
			expect: authorizer.DecisionAllow,
		},
		{
			name:   "allowed patch NodeResourceCapacity",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "patch", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io", Name: "capacity0-node0"},
			expect: authorizer.DecisionAllow,
		},
		{
			name:   "allowed delete NodeResourceCapacity",
			attrs:  authorizer.AttributesRecord{User: node0, ResourceRequest: true, Verb: "delete", Resource: "noderesourcecapacities", APIGroup: "resource.k8s.io", Name: "capacity0-node0"},
			expect: authorizer.DecisionAllow,
		},
	}
...
func populate(graph *Graph, nodes []*corev1.Node, pods []*corev1.Pod, pvs []*corev1.PersistentVolume, attachments []*storagev1.VolumeAttachment, capacities []*resourcev1alpha2.NodeResourceCapacity) {
	p := &graphPopulator{}
	p.graph = graph
	...
	for _, capacity := range capacities {
		p.addNodeResourceCapacity(capacity)
	}
}
...
func generate(opts *sampleDataOpts) ([]*corev1.Node, []*corev1.Pod, []*corev1.PersistentVolume, []*storagev1.VolumeAttachment, []*resourcev1alpha2.NodeResourceCapacity) {
	...
	capacities := make([]*resourcev1alpha2.NodeResourceCapacity, 0, opts.nodes*opts.nodeResourceCapacitiesPerNode)
	...
	for n := 0; n < opts.nodes; n++ {
		...
		for p := 0; p <= opts.nodeResourceCapacitiesPerNode; p++ {
			name := fmt.Sprintf("capacity%d-%s", p, nodeName)
	...
	return nodes, pods, pvs, attachments, capacities
}
