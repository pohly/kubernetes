...
func TestPreCheckForNode(t *testing.T) {
	...
	tests := []struct {
		...
		want               []framework.IsSchedulableResult
	}{
		{
			...
			want: []framework.IsSchedulableResult{framework.PodMaybeSchedulable, framework.PodNotAffected, framework.PodNotAffected, framework.PodMaybeSchedulable, framework.PodNotAffected, framework.PodMaybeSchedulable, framework.PodNotAffected, framework.PodMaybeSchedulable, framework.PodNotAffected},
		},
		{
			...
			want: []framework.IsSchedulableResult{framework.PodNotAffected, framework.PodMaybeSchedulable, framework.PodNotAffected, framework.PodMaybeSchedulable},
		},
		{
			...
			want: []framework.IsSchedulableResult{framework.PodNotAffected, framework.PodNotAffected, framework.PodMaybeSchedulable, framework.PodNotAffected, framework.PodNotAffected},
		},
		{
			...
			want: []framework.IsSchedulableResult{framework.PodNotAffected, framework.PodMaybeSchedulable, framework.PodNotAffected, framework.PodNotAffected},
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var got []framework.IsSchedulableResult
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			for gvk, actionType := range tt.gvkMap {
				clusterEvents = append(clusterEvents, framework.ClusterEventMapEntry{
					ClusterEvent: framework.ClusterEvent{
						Resource:   gvk,
