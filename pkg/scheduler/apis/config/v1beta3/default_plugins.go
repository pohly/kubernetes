...
func getDefaultPlugins(logger klogr.Logger) *v1beta3.Plugins {
...
func applyFeatureGates(logger klogr.Logger, config *v1beta3.Plugins) {
...
func mergePlugins(logger klogr.Logger, defaultPlugins, customPlugins *v1beta3.Plugins) *v1beta3.Plugins {
...
func mergePluginSet(logger klogr.Logger, defaultPluginSet, customPluginSet v1beta3.PluginSet) v1beta3.PluginSet {
