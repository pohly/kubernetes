...
func setDefaults_KubeSchedulerProfile(logger klogr.Logger, prof *v1beta3.KubeSchedulerProfile) {
	// Set default plugins.
...
func SetDefaults_KubeSchedulerConfiguration(obj *v1beta3.KubeSchedulerConfiguration) {
	logger := klogr.TODO() // called by generated code which doesn't pass a logger
