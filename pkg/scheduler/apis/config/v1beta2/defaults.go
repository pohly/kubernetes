...
func setDefaults_KubeSchedulerProfile(logger klogr.Logger, prof *v1beta2.KubeSchedulerProfile) {
	// Set default plugins.
...
func SetDefaults_KubeSchedulerConfiguration(obj *v1beta2.KubeSchedulerConfiguration) {
	logger := klogr.TODO() // called by generated code that doesn't pass a logger
