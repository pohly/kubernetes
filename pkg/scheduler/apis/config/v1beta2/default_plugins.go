...
func getDefaultPlugins(logger klogr.Logger) *v1beta2.Plugins {
...
func applyFeatureGates(logger klogr.Logger, config *v1beta2.Plugins) {
	...
	if !utilfeature.DefaultFeatureGate.Enabled(features.DefaultPodTopologySpread) {
		...
		logger.Info("Registering SelectorSpread plugin")
...
func mergePlugins(logger klogr.Logger, defaultPlugins, customPlugins *v1beta2.Plugins) *v1beta2.Plugins {
...
func mergePluginSet(logger klogr.Logger, defaultPluginSet, customPluginSet v1beta2.PluginSet) v1beta2.PluginSet {
