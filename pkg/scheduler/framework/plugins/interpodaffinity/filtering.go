...
func (pl *InterPodAffinity) getExistingAntiAffinityCounts(logger klogr.Logger, pod *v1.Pod, nsLabels labels.Set, nodes []*framework.NodeInfo, enableNamespaceSelector bool) topologyToMatchedTermCount {
...
func (pl *InterPodAffinity) getIncomingAffinityAntiAffinityCounts(logger klogr.Logger, podInfo *framework.PodInfo, allNodes []*framework.NodeInfo, enableNamespaceSelector bool) (topologyToMatchedTermCount, topologyToMatchedTermCount) {
...
func (pl *InterPodAffinity) PreFilter(ctx context.Context, cycleState *framework.CycleState, pod *v1.Pod) *framework.Status {
	...
	s.existingAntiAffinityCounts = pl.getExistingAntiAffinityCounts(logger, pod, s.namespaceLabels, nodesWithRequiredAntiAffinityPods, pl.enableNamespaceSelector)
	s.affinityCounts, s.antiAffinityCounts = pl.getIncomingAffinityAntiAffinityCounts(logger, s.podInfo, allNodes, pl.enableNamespaceSelector)
