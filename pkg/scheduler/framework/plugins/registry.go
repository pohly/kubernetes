...
func NewInTreeRegistry() runtime.Registry {
	...
	return runtime.Registry{
		...
		nodevolumelimits.CSIName:                   wrap(nodevolumelimits.NewCSI),
		nodevolumelimits.EBSName:                   wrap(nodevolumelimits.NewEBS),
		nodevolumelimits.GCEPDName:                 wrap(nodevolumelimits.NewGCEPD),
		nodevolumelimits.AzureDiskName:             wrap(nodevolumelimits.NewAzureDisk),
		nodevolumelimits.CinderName:                wrap(nodevolumelimits.NewCinder),
