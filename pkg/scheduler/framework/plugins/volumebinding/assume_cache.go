...
func NewAssumeCache(logger klogr.Logger, informer cache.SharedIndexInformer, description, indexName string, indexFunc cache.IndexFunc) AssumeCache {
	c := &assumeCache{
		logger:      logger,
...
func NewPVAssumeCache(logger klogr.Logger, informer cache.SharedIndexInformer) PVAssumeCache {
	logger = klogr.LoggerWithName(logger, "PV Cache")
...
func NewPVCAssumeCache(logger klogr.Logger, informer cache.SharedIndexInformer) PVCAssumeCache {
	logger = klogr.LoggerWithName(logger, "PVC Cache")
