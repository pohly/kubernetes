...
// TODO: remove?!
func fromResourceClaim(in *resourcev1alpha1.ResourceClaim) *resourcev1alpha1ac.ResourceClaimApplyConfiguration {
	out := &resourcev1alpha1ac.ResourceClaimApplyConfiguration{}
	convert(in, out)
	return out
}
