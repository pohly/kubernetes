...
func (sched *Scheduler) addNodeToCache(obj interface{}) {
	...
	logger.V(3).InfoS("Add event for node", "node", klog.KObj(node))
...
func (sched *Scheduler) deleteNodeFromCache(obj interface{}) {
	...
	logger.V(3).InfoS("Delete event for node", "node", klog.KObj(node))
...
func (sched *Scheduler) addPodToCache(obj interface{}) {
	...
	if err := sched.Cache.AddPod(pod); err != nil {
		logger.ErrorS(err, "Scheduler cache AddPod failed", "pod", klog.KObj(pod))
	}
...
func (sched *Scheduler) updatePodInCache(oldObj, newObj interface{}) {
	...
	if err := sched.Cache.UpdatePod(oldPod, newPod); err != nil {
		logger.ErrorS(err, "Scheduler cache UpdatePod failed", "pod", klog.KObj(oldPod))
	}
...
func (sched *Scheduler) deletePodFromCache(obj interface{}) {
	...
	if err := sched.Cache.RemovePod(pod); err != nil {
		logger.ErrorS(err, "Scheduler cache RemovePod failed", "pod", klog.KObj(pod))
	}
