...
func (sched *Scheduler) addNodeToCache(obj interface{}) {
	...
	nodeInfo := sched.SchedulerCache.AddNode(logger, node)
	logger.V(3).Info("Add event for node", "node", klogr.KObj(node))
...
func (sched *Scheduler) updateNodeInCache(oldObj, newObj interface{}) {
	...
	nodeInfo := sched.SchedulerCache.UpdateNode(sched.logger, oldNode, newNode)
...
func (sched *Scheduler) deleteNodeFromCache(obj interface{}) {
	...
	logger.V(3).Info("Delete event for node", "node", klogr.KObj(node))
	if err := sched.SchedulerCache.RemoveNode(sched.logger, node); err != nil {
...
func (sched *Scheduler) addPodToSchedulingQueue(obj interface{}) {
	logger := sched.logger
	pod := obj.(*v1.Pod)
	logger.V(3).Info("Add event for unscheduled pod", "pod", klogr.KObj(pod))
...
func (sched *Scheduler) deletePodFromSchedulingQueue(obj interface{}) {
	...
	logger := sched.logger
	logger.V(3).Info("Delete event for unscheduled pod", "pod", klogr.KObj(pod))
	...
	if err != nil {
		...
		logger.Error(err, "Unable to get profile", "pod", klogr.KObj(pod))
		return
	}
...
func (sched *Scheduler) addPodToCache(obj interface{}) {
	...
	logger.V(3).Info("Add event for scheduled pod", "pod", klogr.KObj(pod))

	if err := sched.SchedulerCache.AddPod(logger, pod); err != nil {
		logger.Error(err, "Scheduler cache AddPod failed", "pod", klogr.KObj(pod))
	}
...
func (sched *Scheduler) updatePodInCache(oldObj, newObj interface{}) {
	...
	logger.V(4).Info("Update event for scheduled pod", "pod", klogr.KObj(oldPod))

	if err := sched.SchedulerCache.UpdatePod(logger, oldPod, newPod); err != nil {
		logger.Error(err, "Scheduler cache UpdatePod failed", "pod", klogr.KObj(oldPod))
	}
...
func (sched *Scheduler) deletePodFromCache(obj interface{}) {
	...
	logger.V(3).Info("Delete event for scheduled pod", "pod", klogr.KObj(pod))
	if err := sched.SchedulerCache.RemovePod(logger, pod); err != nil {
		logger.Error(err, "Scheduler cache RemovePod failed", "pod", klogr.KObj(pod))
	}
