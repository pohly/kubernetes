...
func ValidatePodSchedulingHints(hints *resource.PodSchedulingHints) field.ErrorList {
	...
	allErrs = append(allErrs, validatePodSchedulingSpec(&hints.Spec, field.NewPath("spec"))...)
	return allErrs
}

func validatePodSchedulingSpec(spec *resource.PodSchedulingHintsSpec, fldPath *field.Path) field.ErrorList {
...
func validatePodSchedulingStatus(status *resource.PodSchedulingHintsStatus, fldPath *field.Path) field.ErrorList {
