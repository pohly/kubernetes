...
type DriverAllocationResult struct {
	...
	VendorRequestParameters *runtime.RawExtension
...
type AllocationResultModel struct {
	NamedResources *namedresources.AllocationResult
}
...
type NodeResourceModel struct {
	NamedResources *namedresources.Resources
}
...
type DriverRequests struct {
	...
	VendorParameters *runtime.RawExtension
...
type ResourceRequestModel struct {
	NamedResources *namedresources.Request
}
...
type ResourceFilterModel struct {
	NamedResources *namedresources.Filter
}
