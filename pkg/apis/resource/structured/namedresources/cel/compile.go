...
var valueTypes = map[string]struct {
	celType *cel.Type
	get     func(attr namedresources.Attribute) any
}{
	"quantity": {apiservercel.QuantityType, func(attr namedresources.Attribute) any { return apiservercel.Quantity{Quantity: attr.QuantityValue} }},
	"bool":     {cel.BoolType, func(attr namedresources.Attribute) any { return attr.BoolValue }},
	"int":      {cel.IntType, func(attr namedresources.Attribute) any { return attr.IntValue }},
	"intslice": {types.NewListType(cel.IntType), func(attr namedresources.Attribute) any {
		if attr.IntSliceValue == nil {
			return nil
		}
		return attr.IntSliceValue.Ints
	}},
	"string": {cel.StringType, func(attr namedresources.Attribute) any { return attr.StringValue }},
	"stringslice": {types.NewListType(cel.StringType), func(attr namedresources.Attribute) any {
...
func (c CompilationResult) Evaluate(ctx context.Context, attributes []namedresources.Attribute) (bool, error) {
...
func mustBuildEnv() *environment.EnvSet {
	...
	versioned := buildVersionedAttributes(
		version.MajorMinor(1, 29), // TODO: not correct (?), but necessary to use it with environment.DefaultCompatibilityVersion() = 1.29.
	)
...
func buildVersionedAttributes(introducedVersion *version.Version) environment.VersionedOptions {
...
func buildValueMapper(adapter types.Adapter, attributes []namedresources.Attribute, get func(namedresources.Attribute) any) traits.Mapper {
