...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha2.DriverResources)(nil), (*resource.DriverResources)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_DriverResources_To_resource_DriverResources(a.(*v1alpha2.DriverResources), b.(*resource.DriverResources), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*resource.DriverResources)(nil), (*v1alpha2.DriverResources)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_resource_DriverResources_To_v1alpha2_DriverResources(a.(*resource.DriverResources), b.(*v1alpha2.DriverResources), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_DriverResources_To_resource_DriverResources(in *v1alpha2.DriverResources, out *resource.DriverResources, s conversion.Scope) error {
	out.DriverName = in.DriverName
	out.ResourceInstances = *(*[]runtime.RawExtension)(unsafe.Pointer(&in.ResourceInstances))
	return nil
}

// Convert_v1alpha2_DriverResources_To_resource_DriverResources is an autogenerated conversion function.
func Convert_v1alpha2_DriverResources_To_resource_DriverResources(in *v1alpha2.DriverResources, out *resource.DriverResources, s conversion.Scope) error {
	return autoConvert_v1alpha2_DriverResources_To_resource_DriverResources(in, out, s)
}

func autoConvert_resource_DriverResources_To_v1alpha2_DriverResources(in *resource.DriverResources, out *v1alpha2.DriverResources, s conversion.Scope) error {
	out.DriverName = in.DriverName
	out.ResourceInstances = *(*[]runtime.RawExtension)(unsafe.Pointer(&in.ResourceInstances))
	return nil
}

// Convert_resource_DriverResources_To_v1alpha2_DriverResources is an autogenerated conversion function.
func Convert_resource_DriverResources_To_v1alpha2_DriverResources(in *resource.DriverResources, out *v1alpha2.DriverResources, s conversion.Scope) error {
	return autoConvert_resource_DriverResources_To_v1alpha2_DriverResources(in, out, s)
}
...
func autoConvert_v1alpha2_NodeResourceCapacity_To_resource_NodeResourceCapacity(in *v1alpha2.NodeResourceCapacity, out *resource.NodeResourceCapacity, s conversion.Scope) error {
	...
	out.Resources = *(*[]resource.DriverResources)(unsafe.Pointer(&in.Resources))
	return nil
}
...
func autoConvert_resource_NodeResourceCapacity_To_v1alpha2_NodeResourceCapacity(in *resource.NodeResourceCapacity, out *v1alpha2.NodeResourceCapacity, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Resources = *(*[]v1alpha2.DriverResources)(unsafe.Pointer(&in.Resources))
	return nil
}
