...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.PodResourceClaimReference)(nil), (*core.PodResourceClaimReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_PodResourceClaimReference_To_core_PodResourceClaimReference(a.(*v1.PodResourceClaimReference), b.(*core.PodResourceClaimReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.PodResourceClaimReference)(nil), (*v1.PodResourceClaimReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_PodResourceClaimReference_To_v1_PodResourceClaimReference(a.(*core.PodResourceClaimReference), b.(*v1.PodResourceClaimReference), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_PodResourceClaimReference_To_core_PodResourceClaimReference(in *v1.PodResourceClaimReference, out *core.PodResourceClaimReference, s conversion.Scope) error {
	out.Name = (*string)(unsafe.Pointer(in.Name))
	return nil
}

// Convert_v1_PodResourceClaimReference_To_core_PodResourceClaimReference is an autogenerated conversion function.
func Convert_v1_PodResourceClaimReference_To_core_PodResourceClaimReference(in *v1.PodResourceClaimReference, out *core.PodResourceClaimReference, s conversion.Scope) error {
	return autoConvert_v1_PodResourceClaimReference_To_core_PodResourceClaimReference(in, out, s)
}

func autoConvert_core_PodResourceClaimReference_To_v1_PodResourceClaimReference(in *core.PodResourceClaimReference, out *v1.PodResourceClaimReference, s conversion.Scope) error {
	out.Name = (*string)(unsafe.Pointer(in.Name))
	return nil
}

// Convert_core_PodResourceClaimReference_To_v1_PodResourceClaimReference is an autogenerated conversion function.
func Convert_core_PodResourceClaimReference_To_v1_PodResourceClaimReference(in *core.PodResourceClaimReference, out *v1.PodResourceClaimReference, s conversion.Scope) error {
	return autoConvert_core_PodResourceClaimReference_To_v1_PodResourceClaimReference(in, out, s)
}
...
func autoConvert_v1_PodResourceClaimStatus_To_core_PodResourceClaimStatus(in *v1.PodResourceClaimStatus, out *core.PodResourceClaimStatus, s conversion.Scope) error {
	if err := Convert_v1_PodResourceClaimReference_To_core_PodResourceClaimReference(&in.SourceRef, &out.SourceRef, s); err != nil {
		return err
	}
	out.ResourceClaimName = (*string)(unsafe.Pointer(in.ResourceClaimName))
	return nil
...
func autoConvert_core_PodResourceClaimStatus_To_v1_PodResourceClaimStatus(in *core.PodResourceClaimStatus, out *v1.PodResourceClaimStatus, s conversion.Scope) error {
	if err := Convert_core_PodResourceClaimReference_To_v1_PodResourceClaimReference(&in.SourceRef, &out.SourceRef, s); err != nil {
		return err
	}
	out.ResourceClaimName = (*string)(unsafe.Pointer(in.ResourceClaimName))
	return nil
