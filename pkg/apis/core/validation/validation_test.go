...
func TestValidateOSFields(t *testing.T) {
	...
	osNeutralFields := sets.NewString(
		...
		"ResourceClaims[*].Claim.Template.Spec.Parameters.APIVersion",
		"ResourceClaims[*].Claim.Template.Spec.Parameters.Kind",
		"ResourceClaims[*].Claim.Template.Spec.Parameters.Name",
