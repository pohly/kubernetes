...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*v1alpha1.CSIStorage)(nil), (*storage.CSIStorage)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CSIStorage_To_storage_CSIStorage(a.(*v1alpha1.CSIStorage), b.(*storage.CSIStorage), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*storage.CSIStorage)(nil), (*v1alpha1.CSIStorage)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_storage_CSIStorage_To_v1alpha1_CSIStorage(a.(*storage.CSIStorage), b.(*v1alpha1.CSIStorage), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.CSIStorageByClass)(nil), (*storage.CSIStorageByClass)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CSIStorageByClass_To_storage_CSIStorageByClass(a.(*v1alpha1.CSIStorageByClass), b.(*storage.CSIStorageByClass), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*storage.CSIStorageByClass)(nil), (*v1alpha1.CSIStorageByClass)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_storage_CSIStorageByClass_To_v1alpha1_CSIStorageByClass(a.(*storage.CSIStorageByClass), b.(*v1alpha1.CSIStorageByClass), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.CSIStorageList)(nil), (*storage.CSIStorageList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CSIStorageList_To_storage_CSIStorageList(a.(*v1alpha1.CSIStorageList), b.(*storage.CSIStorageList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*storage.CSIStorageList)(nil), (*v1alpha1.CSIStorageList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_storage_CSIStorageList_To_v1alpha1_CSIStorageList(a.(*storage.CSIStorageList), b.(*v1alpha1.CSIStorageList), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CSIStorage_To_storage_CSIStorage(in *v1alpha1.CSIStorage, out *storage.CSIStorage, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Info = *(*[]storage.CSIStorageByClass)(unsafe.Pointer(&in.Info))
	return nil
}

// Convert_v1alpha1_CSIStorage_To_storage_CSIStorage is an autogenerated conversion function.
func Convert_v1alpha1_CSIStorage_To_storage_CSIStorage(in *v1alpha1.CSIStorage, out *storage.CSIStorage, s conversion.Scope) error {
	return autoConvert_v1alpha1_CSIStorage_To_storage_CSIStorage(in, out, s)
}

func autoConvert_storage_CSIStorage_To_v1alpha1_CSIStorage(in *storage.CSIStorage, out *v1alpha1.CSIStorage, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Info = *(*[]v1alpha1.CSIStorageByClass)(unsafe.Pointer(&in.Info))
	return nil
}

// Convert_storage_CSIStorage_To_v1alpha1_CSIStorage is an autogenerated conversion function.
func Convert_storage_CSIStorage_To_v1alpha1_CSIStorage(in *storage.CSIStorage, out *v1alpha1.CSIStorage, s conversion.Scope) error {
	return autoConvert_storage_CSIStorage_To_v1alpha1_CSIStorage(in, out, s)
}

func autoConvert_v1alpha1_CSIStorageByClass_To_storage_CSIStorageByClass(in *v1alpha1.CSIStorageByClass, out *storage.CSIStorageByClass, s conversion.Scope) error {
	out.StorageClassName = in.StorageClassName
	out.Pools = *(*[]storage.CSIStoragePool)(unsafe.Pointer(&in.Pools))
	return nil
}

// Convert_v1alpha1_CSIStorageByClass_To_storage_CSIStorageByClass is an autogenerated conversion function.
func Convert_v1alpha1_CSIStorageByClass_To_storage_CSIStorageByClass(in *v1alpha1.CSIStorageByClass, out *storage.CSIStorageByClass, s conversion.Scope) error {
	return autoConvert_v1alpha1_CSIStorageByClass_To_storage_CSIStorageByClass(in, out, s)
}

func autoConvert_storage_CSIStorageByClass_To_v1alpha1_CSIStorageByClass(in *storage.CSIStorageByClass, out *v1alpha1.CSIStorageByClass, s conversion.Scope) error {
	out.StorageClassName = in.StorageClassName
	out.Pools = *(*[]v1alpha1.CSIStoragePool)(unsafe.Pointer(&in.Pools))
	return nil
}

// Convert_storage_CSIStorageByClass_To_v1alpha1_CSIStorageByClass is an autogenerated conversion function.
func Convert_storage_CSIStorageByClass_To_v1alpha1_CSIStorageByClass(in *storage.CSIStorageByClass, out *v1alpha1.CSIStorageByClass, s conversion.Scope) error {
	return autoConvert_storage_CSIStorageByClass_To_v1alpha1_CSIStorageByClass(in, out, s)
}

func autoConvert_v1alpha1_CSIStorageList_To_storage_CSIStorageList(in *v1alpha1.CSIStorageList, out *storage.CSIStorageList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]storage.CSIStorage)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_CSIStorageList_To_storage_CSIStorageList is an autogenerated conversion function.
func Convert_v1alpha1_CSIStorageList_To_storage_CSIStorageList(in *v1alpha1.CSIStorageList, out *storage.CSIStorageList, s conversion.Scope) error {
	return autoConvert_v1alpha1_CSIStorageList_To_storage_CSIStorageList(in, out, s)
}

func autoConvert_storage_CSIStorageList_To_v1alpha1_CSIStorageList(in *storage.CSIStorageList, out *v1alpha1.CSIStorageList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]v1alpha1.CSIStorage)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_storage_CSIStorageList_To_v1alpha1_CSIStorageList is an autogenerated conversion function.
func Convert_storage_CSIStorageList_To_v1alpha1_CSIStorageList(in *storage.CSIStorageList, out *v1alpha1.CSIStorageList, s conversion.Scope) error {
	return autoConvert_storage_CSIStorageList_To_v1alpha1_CSIStorageList(in, out, s)
}
