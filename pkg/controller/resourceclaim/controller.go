...
type resourceClaimController struct {
	...
	claimLister  v1listers.ResourceClaimLister
...
func NewController(
	...
	claimInformer v1informers.ResourceClaimInformer) (Controller, error) {
...
func (ec *resourceClaimController) handleClaim(ctx context.Context, pod *v1.Pod, podClaim v1.PodResourceClaim) error {
	...
	claim = &v1.ResourceClaim{
		ObjectMeta: metav1.ObjectMeta{
			...
			Annotations: podClaim.Source.Template.Annotations,
			Labels:      podClaim.Source.Template.Labels,
		},
		Spec: podClaim.Source.Template.Spec,
	}
...
func (ec *resourceClaimController) syncClaim(ctx context.Context, namespace, name string) error {
	...
	valid := make([]v1.ResourceClaimUserReference, 0, len(claim.Status.ReservedFor))
