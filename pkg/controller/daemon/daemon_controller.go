...
func NewDaemonSetsController(
	...
	daemonSetInformer.TypedInformer().AddTypedEventHandler(appsinformers.DaemonSetHandlerFuncs{
	...
	historyInformer.TypedInformer().AddTypedEventHandler(appsinformers.ControllerRevisionHandlerFuncs{
