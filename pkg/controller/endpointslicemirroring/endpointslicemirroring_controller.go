...
func NewController(ctx context.Context, endpointsInformer coreinformers.TypedEndpointsInformer,
	...
	endpointsInformer.TypedInformer().AddTypedEventHandler(coreinformers.EndpointsHandlerFuncs{
		AddFunc: func(obj *v1.Endpoints) {
			c.onEndpointsAdd(logger, obj)
		},
		UpdateFunc: func(oldObj, newObj *v1.Endpoints) {
	...
	endpointSliceInformer.TypedInformer().AddTypedEventHandler(discoveryinformers.EndpointSliceHandlerFuncs{
	...
	serviceInformer.TypedInformer().AddTypedEventHandler(coreinformers.ServiceHandlerFuncs{
