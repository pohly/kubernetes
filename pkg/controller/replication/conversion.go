...
func (i conversionInformer) AddEventHandlerWithContext(ctx context.Context, handler cache.ResourceEventHandler, config cache.HandlerOptions) (cache.ResourceEventHandlerRegistration, error) {
	return i.SharedIndexInformer.AddEventHandlerWithContext(ctx, conversionEventHandler{handler}, config)
}
