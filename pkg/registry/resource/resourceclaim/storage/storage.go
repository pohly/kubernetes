...
func (r *REST) defaultOnRead(obj runtime.Object) {
	...
	case *resource.ResourceClaimList:
...
func (r *REST) defaultOnReadClaimList(list *resource.ResourceClaimList) {
	if list == nil {
		return
	}
...
func (r *REST) defaultOnReadClaim(claim *resource.ResourceClaim) {
	if claim == nil {
		return
	}
