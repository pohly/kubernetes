...
func newStorage(t *testing.T) (*REST, *etcd3testing.EtcdTestServer) {
	...
	restOptions := generic.RESTOptions{
		...
		ResourcePrefix:          "noderesourcecapacityes",
	}
...
func validNewNodeResourceCapacity(name string) *resource.NodeResourceCapacity {
...
func TestCreate(t *testing.T) {
	...
	resourceClass := validNewNodeResourceCapacity("foo")
	resourceClass.ObjectMeta = metav1.ObjectMeta{GenerateName: "foo"}
	test.TestCreate(
		// valid
		resourceClass,
		// invalid
		&resource.NodeResourceCapacity{
...
func TestUpdate(t *testing.T) {
	...
	test.TestUpdate(
		// valid
		validNewNodeResourceCapacity("foo"),
		// updateFunc
...
func TestDelete(t *testing.T) {
	...
	test.TestDelete(validNewNodeResourceCapacity("foo"))
}
...
func TestGet(t *testing.T) {
	...
	defer storage.Store.DestroyFunc()
	test := genericregistrytest.New(t, storage.Store).ClusterScope()
	test.TestGet(validNewNodeResourceCapacity("foo"))
}
...
func TestList(t *testing.T) {
	...
	defer storage.Store.DestroyFunc()
	test := genericregistrytest.New(t, storage.Store).ClusterScope()
	test.TestList(validNewNodeResourceCapacity("foo"))
}
