...
func (r *REST) defaultOnRead(obj runtime.Object) {
	switch s := obj.(type) {
	case *resource.PodScheduling:
		r.defaultOnReadClaim(s)
	case *resource.PodSchedulingList:
...
func (r *REST) defaultOnReadClaimList(list *resource.PodSchedulingList) {
	if list == nil {
		return
	}
...
func (r *REST) defaultOnReadClaim(claim *resource.PodScheduling) {
	if claim == nil {
		return
	}
