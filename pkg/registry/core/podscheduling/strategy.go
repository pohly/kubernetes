...
func (podSchedulingStrategy) PrepareForUpdate(ctx context.Context, obj, old runtime.Object) {
	newScheduling := obj.(*core.PodScheduling)
	oldScheduling := old.(*core.PodScheduling)
...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	scheduling, ok := obj.(*core.PodScheduling)
	if !ok {
...
func toSelectableFields(scheduling *core.PodScheduling) fields.Set {
